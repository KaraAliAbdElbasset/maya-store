        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-12">
                    ...
                    <form action="{{route('profile.update')}}" method="post" class="row mt-5" id="edit-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-lg-4 mb-3">
                            <input type="email" name="email"
                                   ...
                                   value="{{old('email',$user->email)}}" placeholder="Adresse email">
                            @error('email')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            <input type="text" name="phone"
                                   ...
                                   value="{{old('phone',$user->phone)}}" placeholder="Numéro de téléphone">
                            @error('phone')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-8 mb-3">
                            <input type="text" name="address"
                                   ...
                                   value="{{old('address',$user->address)}}" placeholder="Adresse">
                            @error('address')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                            <input type="text" name="city"
                                   class="form-control border-0 shadow-sm py-2 @error('city') is-invalid @enderror"
