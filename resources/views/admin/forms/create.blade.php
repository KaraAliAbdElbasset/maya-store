...
@section('content')
    <section>
        <form action="{{route('admin.forms.store')}}" method="post" encform="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button form="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="category_id">Form category</label>
